...
Um conceito fundamental para segmentar bases de dados, é identificar similiaridades entre os dados. Quando estamos falando sobre dados, normalmente essa similaridade é medida através de medidas de distâncias entre vetores. Na lição de hoje aprenderemos sobre as distâncias Euclidiana, de Manhantan, de Jaccard e de Cosseno.
